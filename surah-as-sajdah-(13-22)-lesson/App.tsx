    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 pb-20">
      ...
      <header className="bg-emerald-900 text-white py-12 px-4 relative overflow-hidden shadow-xl">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-arabic font-bold mb-4">صفات المؤمنين</h1>
          <h2 className="text-2xl md:text-3xl font-light mb-6">Attributes of Believers (Surah As-Sajdah)</h2>
          <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
            Islamic Education • Grade 6 • Verses 13-22
          </p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mt-16 bg-emerald-50 rounded-2xl p-8 border-2 border-emerald-100 text-center mb-16">
          ...
          <p className="text-emerald-700 mb-6">Check your understanding</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
             <div className="bg-white p-6 rounded-xl shadow-sm">
               <h4 className="font-bold text-slate-800 mb-2">Reflection Question</h4>
               <p className="text-slate-600">How does the "Tahajjud" prayer (rising from bed at night) show a believer's sincerity?</p>
               <div className="mt-4 text-xs text-slate-400 uppercase tracking-wide font-bold">Hint: It is a secret between you and Allah.</div>
             </div>
             <div className="bg-white p-6 rounded-xl shadow-sm text-right" dir="rtl">
               ...
               <p className="text-slate-600 font-arabic text-lg">كيف تدل صلاة الليل (تتجافى جنوبهم عن المضاجع) على إخلاص المؤمن؟</p>
               <div className="mt-4 text-xs text-slate-400 uppercase tracking-wide font-bold" dir="ltr">تلميح: لأنها عبادة سرية بينك وبين الله.</div>
             </div>
          </div>
        </div>
